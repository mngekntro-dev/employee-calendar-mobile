    ...
    <View style={styles.container}>
      <View style={isDesktop ? styles.desktopBody : styles.mobileBody}>
        ...
        <View style={isDesktop ? styles.leftPanel : styles.mobileLeft}>
          ...
          <ScrollView
            ref={scrollRef}
            style={[styles.photoGrid, (Platform.OS as string) === 'web' ? { height: winH - 380, flex: undefined } : {}]}
...
const styles = StyleSheet.create({
  ...
  panelHeader: { paddingHorizontal: 10, paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: '#e5e7eb' },
  panelTitle: { fontSize: 14, fontWeight: '800', color: '#111827' },
  sortBtnText2: { fontSize: 13, color: '#059669', fontWeight: '600' },
